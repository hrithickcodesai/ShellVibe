...
# single has: tldr_command, tldr_desc, category, output_command, input_nl
# combo  has: source_tools, source_commands, combined_command_template,
#             combination_description, category, input_nl, output_command
...
# This guarantees no base command appears in both train and test
...
# No source should appear in both splits
